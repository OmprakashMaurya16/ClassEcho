...
const HodReport = () => {
  ...
  // Mock performance data - to be replaced with backend data
  ...
  const departmentMetrics = useMemo(() => {
    ...
    const total = performanceData.reduce((acc, faculty) => ({
    ...
    }), { score: 0, attendance: 0, syllabus: 0, students: 0, feedback: 0, engagement: 0 });
  ...
  // Subject-wise performance (mock)
  const subjectPerformance = [
    { subject: 'Machine Learning', avgScore: 4.7, students: 120, color: 'bg-blue-500' },
    { subject: 'Data Science', avgScore: 4.5, students: 110, color: 'bg-green-500' },
    { subject: 'Database Systems', avgScore: 4.4, students: 130, color: 'bg-purple-500' },
    { subject: 'Cloud Computing', avgScore: 4.3, students: 100, color: 'bg-yellow-500' },
    { subject: 'Web Development', avgScore: 4.2, students: 115, color: 'bg-red-500' },
  ];
      ...
      <main className="flex-1 ml-60">
        ...
        <div className="px-10 py-8">
          ...
          <div className="grid grid-cols-4 gap-6 mb-8">
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="flex items-end gap-2">
                <h2 className="text-4xl font-bold text-gray-800">{departmentMetrics.avgScore}</h2>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="flex items-end gap-2">
                <h2 className="text-4xl font-bold text-gray-800">{departmentMetrics.avgAttendance}</h2>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="flex items-end gap-2">
                <h2 className="text-4xl font-bold text-gray-800">{departmentMetrics.totalStudents}</h2>
              </div>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="flex items-end gap-2">
                <h2 className="text-4xl font-bold text-gray-800">{departmentMetrics.avgEngagement}</h2>
                <span className="text-xs text-gray-500 mb-1">%</span>
              </div>
              <div className="mt-2 h-1.5 bg-gray-100 rounded-full overflow-hidden">
                <div 
          ...
          <div className="grid grid-cols-2 gap-6 mb-8">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              <div className="flex items-center justify-between mb-6">
                <h3 className="font-semibold text-gray-800">6-Month Performance Trend</h3>
              ...
              <div className="relative w-full h-64">
                <svg className="w-full h-full" viewBox="0 0 500 240" preserveAspectRatio="xMidYMid meet">
                  {/* Y-axis labels */}
                  <text x="5" y="20" className="fill-gray-400" fontSize="12">5.0</text>
                  <text x="5" y="80" className="fill-gray-400" fontSize="12">4.0</text>
                  <text x="5" y="140" className="fill-gray-400" fontSize="12">3.0</text>
                  <text x="5" y="200" className="fill-gray-400" fontSize="12">2.0</text>
                  ...
                  <div key={idx}>
                    <div className="flex justify-between text-sm mb-2">
                      <div>
                        ...
                        <span className="text-gray-500 text-xs ml-2">({subject.students} students)</span>
                      </div>
                      <span className="font-semibold text-gray-800">{subject.avgScore}</span>
                    </div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 mb-8">
            <div className="flex items-center justify-between mb-6">
              <h3 className="font-semibold text-gray-800 text-lg">Faculty Performance Overview</h3>
              <span className="text-sm text-gray-500">{performanceData.length} Faculty Members</span>
            </div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-gray-200">
                    ...
                    <th className="text-center py-3 px-4 text-sm font-semibold text-gray-600">Syllabus %</th>
                    <th className="text-center py-3 px-4 text-sm font-semibold text-gray-600">Engagement</th>
                    <th className="text-center py-3 px-4 text-sm font-semibold text-gray-600">Students</th>
                    <th className="text-center py-3 px-4 text-sm font-semibold text-gray-600">Feedback</th>
                  </tr>
                </thead>
                <tbody>
                    ...
                    <tr key={faculty.id} className="border-b border-gray-100 hover:bg-gray-50">
                      <td className="py-4 px-4">
                        <div className="flex items-center gap-3">
                          <Avatar name={faculty.name} color={faculty.avatarColor} size="sm" />
                          <div>
                            <p className="font-medium text-gray-800 text-sm">{faculty.name}</p>
                      ...
                      <td className="py-4 px-4 text-center">
                        <div className="flex items-center justify-center gap-1">
                          ...
                          <span className="font-semibold text-gray-800">{faculty.overallScore}</span>
                        </div>
                      </td>
                      <td className="py-4 px-4 text-center">
                        ...
                        <div className="flex items-center justify-center gap-2">
                          <div className="w-16 h-1.5 bg-gray-100 rounded-full overflow-hidden">
                            <div 
                              ...
                              style={{ width: `${faculty.syllabusCompletion}%` }}
                            />
                          </div>
                          <span className="text-xs text-gray-600">{faculty.syllabusCompletion}%</span>
                        </div>
                      </td>
                      <td className="py-4 px-4 text-center">
                        <span className="text-sm text-gray-700">{faculty.studentEngagement}%</span>
                      </td>
                      <td className="py-4 px-4 text-center">
                        <span className="text-sm text-gray-700">{faculty.totalStudents}</span>
                      </td>
                      <td className="py-4 px-4 text-center">
                        <span className="text-sm text-gray-700">{faculty.feedbackCount}</span>
                      </td>
                    </tr>
                  ))}
                </tbody>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="space-y-4">
                {topPerformers.map((faculty, idx) => (
                  <div key={faculty.id} className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                    <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-1 bg-white px-3 py-1.5 rounded-lg">
                      <Star size={14} className="text-yellow-400 fill-yellow-400" />
                      <span className="font-bold text-gray-800">{faculty.overallScore}</span>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="space-y-4">
                {needsImprovement.map((faculty, idx) => (
                  <div key={faculty.id} className="flex items-center justify-between p-3 bg-orange-50 rounded-lg">
                    <div className="flex items-center gap-3">
                      <div className="flex items-center gap-2">
                        <Avatar name={faculty.name} color={faculty.avatarColor} size="sm" />
                        <div>
                    ...
                    <div className="text-right">
                      <div className="flex items-center gap-1 mb-1">
                        ...
                        <span className="font-semibold text-gray-700">{faculty.overallScore}</span>
                      </div>
                      <p className="text-xs text-orange-600">Follow-up required</p>
                    </div>
                  </div>
                ))}
              </div>
          ...
          <div className="bg-linear-to-r from-blue-50 to-purple-50 rounded-xl shadow-sm p-6 border border-blue-100">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <h3 className="font-semibold text-gray-800 mb-3">Key Insights & Recommendations</h3>
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-white bg-opacity-60 rounded-lg p-4">
                    ...
                    <ul className="text-xs text-gray-600 space-y-1">
                      <li>• Overall performance improved by 7% this semester</li>
                  ...
                  <div className="bg-white bg-opacity-60 rounded-lg p-4">
                    ...
                    <ul className="text-xs text-gray-600 space-y-1">
                      <li>• Schedule feedback sessions with 3 faculty members</li>
                      <li>• Review teaching methodologies for low-rated subjects</li>
