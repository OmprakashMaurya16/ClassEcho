...
const ManageFaculty = () => {
  const { searchQuery, departmentFilter, handleSearchChange, handleDepartmentChange, departments } = useFaculty();
    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <main className="flex-1 flex flex-col ml-60">
        <div className="flex items-center justify-between px-10 py-6 border-b border-gray-200 bg-white">
          <div>
            <h2 className="text-2xl font-bold text-gray-800 mb-1">Faculty Directory</h2>
            <p className="text-gray-500 text-sm">Manage all registered faculty members</p>
          </div>
