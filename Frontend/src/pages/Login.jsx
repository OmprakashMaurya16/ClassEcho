...
// TODO: Replace localStorage auth with API-based authentication
...
const Login = () => {
  ...
  const handleLogin = (e) => {
    ...
    // const response = await authAPI.login({ email: idOrEmail, password, role: selectedRole });
    ...
    // HOD login
      ...
      const hodCredentials = {
        "hod_inft": { password: "hod123", department: "INFT", name: "Dr. INFT Head" },
        "hod_cmpn": { password: "hod123", department: "CMPN", name: "Dr. CMPN Head" },
        "hod_extc": { password: "hod123", department: "EXTC", name: "Dr. EXTC Head" },
        "hod_excs": { password: "hod123", department: "EXCS", name: "Dr. EXCS Head" },
        "hod_biomed": { password: "hod123", department: "BIOMED", name: "Dr. BIOMED Head" },
      };
      
      const hodKey = idOrEmail.toLowerCase();
      if (hodCredentials[hodKey] && password === hodCredentials[hodKey].password) {
        window.localStorage.setItem("isHOD", "true");
        window.localStorage.setItem("userRole", "HOD");
        window.localStorage.setItem("hodDepartment", hodCredentials[hodKey].department);
    ...
    // Faculty login
      ...
      // Find faculty by email using helper function
      ...
      if (faculty) {
        // Use helper to get first name and validate password
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 py-12">
      ...
      <div className="w-full max-w-md p-8 bg-white rounded-2xl shadow-lg flex flex-col items-center">
        <form className="w-full" onSubmit={handleLogin}>
          ...
          <button
            type="submit"
            className="w-full flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2.5 rounded-lg text-base shadow transition-colors duration-150 mb-2"
          >
            <ArrowRight />
            Secure Login
          </button>
