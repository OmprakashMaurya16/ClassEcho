...
import { TrendingUp, Users, MessageSquare, Award, ArrowLeft, ThumbsUp, ThumbsDown, Calendar } from 'lucide-react';
...
const FacultyReportPage = () => {
  ...
  const parameterData = {
    labels: ['Content Quality', 'Clarity', 'Engagement', 'Response Time', 'Innovation', 'Preparedness'],
    datasets: [
      {
  ...
  const allFeedback = [
    {
      ...
      rating: 5,
      comment: 'Excellent explanation of complex concepts. Very engaging lectures.',
      sentiment: 'positive'
    },
    {
      id: 2,
  ...
  const recentFeedback = activeTab === 'Overall' 
    ? allFeedback 
      ...
      <div className="flex-1 ml-60 bg-gray-50 min-h-screen">
            ...
            <div className="flex items-start justify-between">
              <div>
                ...
                <p className="text-gray-600">
                  {currentFaculty?.name || facultyName} • {facultyDepartment} Department
                </p>
              </div>
        ...
        <div className="p-8">
          ...
          <div className="grid grid-cols-4 gap-6 mb-8">
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm text-gray-500 font-medium">Overall Rating</span>
                <div className="w-10 h-10 bg-blue-100 rounded-lg flex items-center justify-center">
                  <Award className="text-blue-600" size={20} />
                </div>
              </div>
              <p className="text-3xl font-bold text-gray-900 mb-1">{currentData.overallRating}</p>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm text-gray-500 font-medium">Total Responses</span>
                <div className="w-10 h-10 bg-green-100 rounded-lg flex items-center justify-center">
                  <Users className="text-green-600" size={20} />
                </div>
              </div>
              <p className="text-3xl font-bold text-gray-900 mb-1">{currentData.totalResponses}</p>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
              ...
              <p className="text-3xl font-bold text-gray-900 mb-1">{currentData.responseRate}%</p>
              <p className="text-sm text-gray-500">Above department avg</p>
            </div>

            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm text-gray-500 font-medium">Positive Sentiment</span>
                <div className="w-10 h-10 bg-orange-100 rounded-lg flex items-center justify-center">
                  <ThumbsUp className="text-orange-600" size={20} />
                </div>
              </div>
              <p className="text-3xl font-bold text-gray-900 mb-1">{currentData.positiveSentiment}%</p>
          ...
          <div className="grid grid-cols-2 gap-6 mb-6">
            ...
            {/* Parameter Analysis */}
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
              <h3 className="text-lg font-bold text-gray-900 mb-4">Parameter Analysis</h3>
              <div className="h-80">
          ...
          <div className="grid grid-cols-2 gap-6 mb-6">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
              <h3 className="text-lg font-bold text-gray-900 mb-4">Feedback Sentiment</h3>
