  ...
  const getPerformanceLevel = () => {
    if (percentage >= 80)
      return {
        ...
        color: "green",
        message:
          "Outstanding performance! You have a strong grasp of the subject.",
      };
    if (percentage >= 60)
      return {
        level: "Good",
        color: "blue",
        message: "Good job! There are some areas where you can improve.",
      };
    if (percentage >= 40)
      return {
        level: "Fair",
        color: "yellow",
        message: "Fair performance. Consider reviewing the weak areas.",
      };
    return {
      level: "Needs Improvement",
      color: "red",
      message: "Additional preparation needed. Focus on the weak topics.",
    };
  };
    ...
    <div className="flex">
      ...
      <div className="flex-1 ml-60 min-h-screen bg-gray-50">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-gray-600">
                  {subject || "General Teaching"} Assessment
                </p>
              </div>
              <button
        ...
        <div className="max-w-6xl mx-auto px-8 py-10">
          <div className="bg-linear-to-br from-blue-600 to-indigo-600 rounded-2xl p-8 text-white mb-10">
            ...
            <div
              className={`mt-6 p-4 bg-white bg-opacity-10 rounded-lg border border-white border-opacity-20`}
            >
          ...
          {weakTopics.length > 0 && (
            <div className="bg-linear-to-br from-purple-50 to-pink-50 rounded-2xl border border-purple-200 p-8 mb-8">
              ...
              <div className="space-y-6">
                {weakTopics.map((weakTopic, index) => {
                  const suggestions =
                    improvementSuggestions[weakTopic.topic] ||
                      ...
                      <div className="flex items-start gap-4 mb-4">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-gray-600">
                            Score: {weakTopic.correct}/{weakTopic.total} (
                            {weakTopic.percentage.toFixed(0)}%)
                          </p>
                        </div>
                      </div>
