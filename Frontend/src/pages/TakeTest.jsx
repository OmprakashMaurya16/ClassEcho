...
import { GraduationCap, Clock, CheckCircle, AlertCircle, Send } from 'lucide-react';
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="text-center">
          ...
          <h2 className="text-xl md:text-2xl font-bold text-gray-900 mb-2">Assessment Not Found</h2>
          <p className="text-sm md:text-base text-gray-600">This assessment may have been deleted or the link is invalid.</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="text-center">
          ...
          <h2 className="text-xl md:text-2xl font-bold text-gray-900 mb-2">Assessment Closed</h2>
          <p className="text-sm md:text-base text-gray-600">This assessment is no longer accepting submissions.</p>
        </div>
      </div>
    );
  }
      ...
      <div className="min-h-screen bg-linear-to-br from-green-50 to-blue-50 flex items-center justify-center p-4 md:p-6">
        <div className="max-w-md w-full bg-white rounded-xl md:rounded-2xl shadow-xl p-6 md:p-8 text-center">
          ...
          <div className="bg-gray-50 rounded-lg p-4 md:p-6 mb-4 md:mb-6">
            ...
            <p className="text-2xl md:text-3xl font-bold text-blue-600">{formatTime(timeElapsed)}</p>
          </div>
          
          <p className="text-sm text-gray-500">
            Your faculty will analyze the results to identify areas for improvement in teaching.
          </p>
        </div>
      </div>
    );
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="bg-white border-b border-gray-200">
          <div className="max-w-4xl mx-auto px-4 md:px-6 py-4 md:py-6 flex items-center gap-2 md:gap-3">
            ...
            <span className="text-lg md:text-xl font-bold text-gray-900">ClassEcho Assessment</span>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 md:px-6 py-6 md:py-12">
          <div className="bg-white rounded-xl md:rounded-2xl shadow-sm border border-gray-200 p-5 md:p-8">
            ...
            <p className="text-sm md:text-base text-gray-600 mb-4 md:mb-6">{assessment.subject}</p>
            
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 md:p-6 mb-6 md:mb-8">
              <h3 className="text-sm md:text-base font-semibold text-gray-900 mb-2 md:mb-3">About This Assessment</h3>
              <p className="text-sm md:text-base text-gray-700 mb-3 md:mb-4">{assessment.description}</p>
    ...
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex items-center justify-between gap-3 mb-2 md:mb-3">
            <div className="flex items-center gap-2 md:gap-3 min-w-0">
              ...
              <div className="min-w-0">
                <h2 className="text-sm md:text-base font-bold text-gray-900 truncate">{assessment.title}</h2>
                <p className="text-xs md:text-sm text-gray-600 truncate">{studentName}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2 md:gap-4 shrink-0">
              <div className="flex items-center gap-1 md:gap-2 text-gray-600">
                <Clock size={16} />
                <span className="text-xs md:text-sm font-medium">{formatTime(timeElapsed)}</span>
              </div>
      ...
      <div className="max-w-4xl mx-auto px-4 md:px-6 py-4 md:py-8">
        ...
        <div className="mt-4 md:mt-6 bg-gray-100 rounded-lg md:rounded-xl p-4 md:p-6">
          <h4 className="text-sm md:text-base font-semibold text-gray-900 mb-2 md:mb-3">Question Overview</h4>
